...
CHAPTER_RELEVANCE = {
    ...
    "tech-it": {
        ...
        "negative": ["아파트", "주택", "청약", "부동산", "전세", "재건축", "영끌", "집 사", "주택 구매", "주택구매"],
    },
    "ai-deeptech": {
