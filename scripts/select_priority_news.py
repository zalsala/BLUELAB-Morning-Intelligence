...
POLICY = {
    '국제 · 외교 · 안보': {'max_age_days':3,'keywords':['iran','russia','ukraine','g20','nato','china','taiwan','war','strike','strikes','missile','drone','sanction','sanctions','security','defense','defence','diplomacy','diplomatic','government','border','nuclear','ceasefire','military','trade war','venezuela','dictatorship','opposition','election','elections','constitution','constitutional','parliament','president','political','politics','court','crisis'],'exclude':['football','rugby','tour','singer','actor','arcade','game','celebrity','baseball','trial deadlocked','cold case']},
    '과학': {'max_age_days':8,'keywords':['nasa','space','mars','moon','earth','climate','science','scientific','research','study','particle','physics','astronomy','telescope','glacier','ocean','weather','solar','quantum','genome','biology','iceberg','mission','satellite','cyclone'],'exclude':['sports','football','celebrity','game','shopping','apod','skywatching tips','what s up']},
...
def self_test():
    ...
    accepts=[
      ...
      {'chapter':'국제 · 외교 · 안보','title':'Opposition parties challenge constitutional court ruling before election','summary':'Political crisis and election dispute','url':'https://world.example/election','domain':'world.example','published':'2026-09-02','tier':2,'source':'News'},
      {'chapter':'과학','title':'Autism mutations rewire protein interaction networks','summary':'Scientific research study','url':'https://science.example/research','domain':'science.example','published':'2026-08-26T12:00:00+00:00','tier':1,'source':'Science'}]
