...
# be used as grounding. HTTP/network/content-type/collector failure states below
# are retained explicitly so an inaccessible response never becomes fabricated
# evidence. They are acceptable provenance states only; they cannot masquerade
# as body-validated evidence.
ALLOWED_BODY_VALIDATION_STATES={"VALIDATED","EVENT_MISMATCH","NO_QUALIFIED_BODY","HTTP_403","HTTP_404","HTTP_429","TIMEOUT","NON_HTML","NETWORK_ERROR","PARSE_ERROR","COLLECTOR_ERROR"}
