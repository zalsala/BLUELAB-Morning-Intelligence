...
def main():
    ...
    try:
        ...
        # P2: discover only representative images declared by the selected exact
        # article page, verify the image response, suppress duplicate content,
        # then pass through the strict provenance gate. Missing images stay null.
